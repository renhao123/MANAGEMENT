...
export default class Index extends Component {
    constructor(props){
        ...
        this.state = {
            dataSource:[
                // {rewardName:"包含奖贷勤助免信息",money:"4969",type:"国家级",level:2,time:"2018/02/05",sortIndex:"1"}
            ],
            pageInfo:{
                pageSize:5,
                current:1,
    ...
    getTableData = () => {
        ...
        let res = {
            obj:{
                dataList:[
                    {rewardName:"包含奖贷勤助免信息",money:"4969",type:"国家级",level:2,time:"2018/02/05",sortIndex:1},
                    {rewardName:"包含奖贷勤助免信息",money:"4969",type:"国家级",level:2,time:"2018/02/05",sortIndex:2},
                    {rewardName:"包含奖贷勤助免信息",money:"4969",type:"国家级",level:2,time:"2018/02/05",sortIndex:3},
                    {rewardName:"包含奖贷勤助免信息",money:"4969",type:"国家级",level:2,time:"2018/02/05",sortIndex:4},
                    {rewardName:"包含奖贷勤助免信息",money:"4969",type:"国家级",level:2,time:"2018/02/05",sortIndex:5},
                ],
                total:15,
                pageNum:1,
                pageSize:5,
